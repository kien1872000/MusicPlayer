...
class ListenALotSongsAdapter(var context: Context?, var songs: ArrayList<Song>): RecyclerView.Adapter<ListenALotSongsAdapter.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            intent.putExtra("category", "listenALot")
            intent.putExtra("listALotList", MainActivity.musicPlayerDbHelper!!.getTopHeardTimes())
